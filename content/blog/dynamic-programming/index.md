...
<div class="info-box">
Note: And my friend has set count=1 and not 0 initially because when we have a case where all numbers are same in the array i.e {2, 2, 2, 2}. We must return count as 1 since one element { 2 } is the still a subarray of the larger one.
</div>
